...
def doKMeans(df):
    ...
    model = DBSCAN(eps=0.5, min_samples=5, metric="euclidean", metric_params=None, algorithm="auto", leaf_size=30,
                   p=None, n_jobs=1)
    model.fit(sliceK)
    print(model)
    #
...
#
df = pd.read_csv(r"C:\Users\shrip\Downloads\CS 267 dataset\Test Reduction\\forSaurabhWeka.csv", index_col="IUCR")
